...
<body>
        ...
        <table align="center">
            ...
            <form action="{{ url('orderconfirm') }}" method="post">
                ...
                @foreach ($data as $data)
                    <tr align="center">
                        <td><input type="text" name="foodname[]" value="{{ $data->title }}"
                                hidden="">{{ $data->title }}</td>
                        <td><input type="text" name="price[]" value="{{ $data->price }}" hidden="">Rp
                            {{ $data->price }}</td>
                        <td><input type="text" name="quantity[]" value="{{ $data->quantity }}"
                                hidden="">{{ $data->quantity }}</td>
                    </tr>
                @endforeach
    ...
    <div id="appear" align="center" style="padding: 10px; display:none;">
        ...
        <div style="padding: 10px;">
            ...
            <button id="close" type="button" class="btn btn-danger">Tutup</button>
        </div>
    </div>
    </form>
