                    ...
                    <div class="left-content">
                        <div class="inner-content">
                            ...
                            <div class="main-white-button scroll-to-section">
                                <a href="#reservation">Lakukan Reservasi</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Imigran Cafe is one of the best. Makanan yang disajikan kepada tamu dalam keadaan fresh
                            dan sistem pengelolaan yang baik, penyimpanan bahan baik, peralatan dan pelengkapan
                            berkualitas tinggi dan higienis, cita rasa makanan baik dan sesuai dengan lidah
                            pemesananya.
                        </p>
                        <div class="row">
                            <div class="col-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-4 text-center">
                    <div class="section-heading">
                        <h6>Imigran Cafe</h6>
                        <h2>Penawaran Makanan Khusus Minggu Ini</h2>
                    </div>
                </div>
            </div>
            <div class="row">
